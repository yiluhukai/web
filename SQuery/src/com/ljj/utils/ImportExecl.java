...
import org.apache.poi.ss.usermodel.Row;
	...
	public class ImportExecl
	{
		...
		public List<List<String>> read(String filePath,String fileName)
		{
			...
			try
			{
				...
				if (!validateExcel(filePath,fileName))
				{
		...
		private List<List<String>> read(Workbook wb)
		{
			...
			if(this.totalRows > 1 && sheet.getRow(0) != null&&sheet.getRow(1) != null)
			{
				//多行的时候
				int r1=sheet.getRow(0).getPhysicalNumberOfCells();int r2=sheet.getRow(1).getPhysicalNumberOfCells();
				this.totalCells =r1>r2?r1:r2;	
